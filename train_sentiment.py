...
if __name__ == "__main__":
    ...
    tf.app.flags.DEFINE_string('embedding_file', None, 'path to prepared embeddings (see prepare_sentiment.py)')
    ...
    tf.app.flags.DEFINE_string("cell", None, "'LSTM', 'GRU', 'RNN', 'MaxLSTM', 'MaxGRU', 'MaxRNN'")
